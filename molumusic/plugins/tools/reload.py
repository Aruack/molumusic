...
from molumusic import app
from molumusic.core.call import Shizuka
from molumusic.misc import db
from molumusic.utils.database import get_authuser_names, get_cmode
from molumusic.utils.decorators import ActualAdminCB, AdminActual, language
from molumusic.utils.formatters import alpha_to_int
...
@app.on_message(
    filters.command(
        RELOAD_COMMAND) & filters.group & ~filters.edited & ~BANNED_USERS
)
@language
...
@app.on_message(
    filters.command(
        RESTART_COMMAND) & filters.group & ~filters.edited & ~BANNED_USERS
)
@AdminActual
